...
use Entrago\CRUDBundle\Entity\Book;
use Entrago\CRUDBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EntragoCRUDBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("EntragoCRUDBundle:Book:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EntragoCRUDBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EntragoCRUDBundle:Book:edit.html.twig")
     */
