...
use Entrago\CRUDBundle\Entity\Contact;
use Entrago\CRUDBundle\Form\ContactType;
...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EntragoCRUDBundle:Contact')->findAll();
     ...
     * @Method("POST")
     * @Template("EntragoCRUDBundle:Contact:new.html.twig")
     */
    ...
    */
    ...
    public function newAction()
    {
        ...
        if ($book_id) {
            ...
            $em = $this->getDoctrine()->getManager();
            $entity_book = $em->getRepository('EntragoCRUDBundle:Book')->find($book_id);
            if (!$entity_book) {
                throw $this->createNotFoundException('Unable to find Book entity.');
            }

            // Set the book entity based on slug
            $entity->setBook($entity_book);
        }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EntragoCRUDBundle:Contact')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EntragoCRUDBundle:Contact:edit.html.twig")
     */
